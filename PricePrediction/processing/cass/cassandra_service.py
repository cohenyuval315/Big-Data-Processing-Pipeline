...
class CassandraService:
    def __init__(self,addresses = ["127.0.0.1"],port=9042, keyspace="btcusdt",table="one_minute") -> None:
        ...
        self.create_table_if_not_exists("one_minute")
        self.create_table_if_not_exists("one_second")
